...
# Comfort link
ln -s /etc/ssh/sshd_config.d/99-custom-hardening.conf ~/.shlib/99-custom-hardening.conf
```
...
# comfort link
ln -s /etc/fail2ban/jail.local ~/.shlib/jail.local
```
...
* This is described in detail in the docker chapter
